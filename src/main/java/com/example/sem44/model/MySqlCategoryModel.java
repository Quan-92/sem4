...
public class MySqlCategoryModel {
    ...
    public boolean save(Category category) {
        try {
            Connection connection = com.example.sem44.util.ConnectionHelper.getConnection();
